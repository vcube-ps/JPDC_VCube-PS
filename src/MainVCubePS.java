...
public static void main(String[] args)
{
	...
	try {
		...
		for(int k=0; k<exps; ++k)
		{
			...
			oracle.setCycleSteps(Configuration.getInt("STEPS_PER_CYCLE"));
			oracle.setApplicationCycle(Configuration.getInt("APPLICATION_CYCLE"));
			oracle.setBroadcastCycle(Configuration.getInt("BROADCAST_CYCLE"));
			oracle.setTopologyCycle(Configuration.getInt("TOPOLOGY_CYCLE"));
			oracle.setFastSubscription(Configuration.getBoolean("FAST_SUB", false));
			...
			System.err.println("Number of nodes: " + Configuration.getInt("SIZE"));
			System.err.println("Simulation cycles for cycle-driven simulation: " + Configuration.getInt("NUMBER_OF_CYCLES"));
			System.err.println("Steps per cycle: " + oracle.getCycleSteps());
			System.err.println("Topology cycle: " + oracle.getTopologyCycle());
			System.err.println("Broadcast cycle: " + oracle.getBroadcastCycle());
			System.err.printf("Topology transport delay: [%d, %d]\n",  
				Configuration.getInt("MIN_DELAY_TOPOLOGY"), 
				Configuration.getInt("MAX_DELAY_TOPOLOGY")
			);
			System.err.printf("Broadcast transport delay: [%d, %d]\n",  
				Configuration.getInt("MIN_DELAY_BCAST"), 
				Configuration.getInt("MAX_DELAY_BCAST")
			);
			System.out.println("");
